...
//   // Filtering logic (industry + search)
//   useEffect(() => {
//     let filtered = ProjectsData;

//     // Industry filter
//     if (activeIndustry !== "All") {
//       filtered = filtered.filter((p) => p.industry === activeIndustry);
//     }
...
//           className="w-full md:w-1/2 px-4 py-2 border border-mainDark/40 rounded-lg 
//                      focus:outline-none focus:ring-2 focus:ring-mainDark transition-all"
//         />
//       </div>
...
//           ))
//         ) : (
//           <p className="text-center text-gray-500 text-xl col-span-3">
//             No projects found.
//           </p>
//         )}
//       </div>
