          ...
          >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 text-mainDark rounded-md bg-transparent border border-mainBrown focus:outline-none focus:ring-2 focus:ring-mainBrown transition-all"
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={6}
                    className="w-full px-4 py-3 text-mainDark rounded-md bg-transparent border border-mainBrown focus:outline-none focus:ring-2 focus:ring-mainBrown transition-all resize-none"
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                disabled={success}
                className={`group relative px-12 py-4 bg-mainBrown text-white font-semibold rounded-lg overflow-hidden transition-all duration-300 hover:bg-mainBrown/90 hover:shadow-xl ${success ? "bg-green-600" : ""}`}
              >
