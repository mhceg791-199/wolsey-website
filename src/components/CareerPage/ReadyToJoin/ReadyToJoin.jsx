    ...
    <>
      <section className="relative md:py-12 overflow-hidden bg-black text-white">
        ...
        <div className="relative z-10 w-3/4 mx-auto text-center md:py-8">
          ...
          <Paragraph p="Pioneer the future with a team dedicated to ambition, excellence, and boundless growth. Explore opportunities to elevate your career with a firm invested in your global impac" />
